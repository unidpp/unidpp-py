...
Generated: 2026-09-07T02:07:50Z
...
| Fixture | Clause | Kind | Parsed | Outcome | Findings |
|---|---|---|---|---|---|
| cl5-5.2.4-header | 5.2.4 | json-compressed | yes | fail | A1-granularity-casing (A1), A2-status-casing (A2), A6-schema-version-placeholder (A6), C4-content-spec-placeholder (C4) |
| cl5-5.2.5-dataelementcollection | 5.2.5 | json-compressed | yes | pass | — |
| cl5-5.2.6-singlevalued-standalone | 5.2.6 | json-compressed | yes | pass | — |
| cl5-5.2.6-singlevalued-in-complex | 5.2.6 | json-compressed | yes | pass | — |
| cl5-5.2.7-multivalued-native | 5.2.7 | json-compressed | yes | pass | — |
| cl5-5.2.7-multivalued-objects | 5.2.7 | json-compressed | yes | pass | — |
| cl5-5.2.8-relatedresource | 5.2.8 | json-compressed | yes | pass | — |
| cl5-5.2.9-multilanguage | 5.2.9 | json-compressed | yes | pass | — |
| annexA-example1 | Annex A, Example 1 | json-expanded | yes | fail | A3-class-name-drift (A3), A3-class-name-drift (A3), A3-class-name-drift (A3), A3-class-name-drift (A3), C1-repository-placeholder (C1) |
| annexA-example2 | Annex A, Example 2 | json-expanded | no | fail | N1-example-not-valid-json (N1) |
| annexA-example3 | Annex A, Example 3 | json-expanded | yes | fail | A3-class-name-drift (A3), N2-dictionary-reference-malformed-uri (N2), A3-class-name-drift (A3), N2-dictionary-reference-malformed-uri (N2) |
| annexA-example4 | Annex A, Example 4 | json-expanded | yes | fail | N5-multivalued-child-key-divergence (N5), N3-duplicate-element-id (N3), A3-class-name-drift (A3), N4-value-data-type-mismatch (N4), A3-class-name-drift (A3), N4-value-data-type-mismatch (N4), A3-class-name-drift (A3), N4-value-data-type-mismatch (N4), C1-repository-placeholder (C1) |
| annexA-example5 | Annex A, Example 5 | json-expanded | no | fail | N6-trailing-comma (N6), A5-language-tag-structure (A5) |
| annexA-example6 | Annex A, Example 6 | json-expanded | yes | fail | A5-language-tag-unassigned (A5) |
| annexB-example1 | Annex B, Example 1 | xml | yes | fail | A1-granularity-casing (A1), A2-status-casing (A2), A6-schema-version-placeholder (A6), C4-content-spec-placeholder (C4) |
| annexB-example2 | Annex B, Example 2 | xml | yes | pass | — |
| annexB-example3 | Annex B, Example 3 | xml | yes | pass | — |
| annexB-example4 | Annex B, Example 4 | xml | yes | pass | — |
| annexB-example5 | Annex B, Example 5 | xml | yes | pass | — |
| annexB-example6 | Annex B, Example 6 | xml | yes | pass | — |
| annexB-example7 | Annex B, Example 7 | xml | yes | pass | — |
| annexB-example8 | Annex B, Example 8 | xml | yes | pass | — |
